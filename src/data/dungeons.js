export const dungeonsData = [
  {
    ...
    dungeons: [
      ...
      },
      {
        ...
        mainStoryQuest: true,
        dungeonTips: [
          "Be wary of the Manor Maidservants, avoid their stun circle AoE."
        ],
        bossList: [
          {
            ...
            bossTips: [
              {
                desc:
                  "Only tank should stand in front of boss for Frontal cleave attack.",
                icon: "tank"
              },
              {
        ...
        bossList: [
          ...
          },
          {
            ...
            bossTips: [
              ...
              {
                desc:
                  "Boss will trap random player in BUBBLE, destroy BUBBLE asap.",
                icon: "avoid"
              },
              {
          ...
          },
          {
            ...
            bossTips: [
              ...
              {
                desc:
                  "Boss will randomly turn and spit poison goo and damage on player.",
                icon: "heal"
              },
              {
                desc:
                  "Do not stand inside poison pool and move dragon away from it as well.",
                icon: "avoid"
              },
              {
      ...
      },
      {
        ...
        dungeonTips: [
          "Scales of Judgement: LEFT - Flame of Magic, RIGHT - Fruit of Knowledge"
        ],
        bossList: [
          {
            bossName: "Terotaur",
            bossTips: [
              ...
              },
              {
                spellName: "DOOM",
                desc:
                  " - players must run to glowing platform to remove 'doom' debuff or will cause instant death.",
                icon: "mechanic"
              }
            ]
          },
          {
            ...
            bossTips: [
              ...
              {
                desc:
                  "Healers be ready to heal random party member targeted by boss when golem soulstone respawns.",
                icon: "general"
              }
            ]
          },
        ...
        bossList: [
          ...
          },
          {
            ...
            bossTips: [
              ...
              {
                desc:
                  "Try not to stand in path of boss when boss burrows under the sand.",
                icon: "avoid"
              }
            ]
          },
  ...
  },
  {
    ...
    dungeons: [
        ...
        bossList: [
          {
            ...
            bossTips: [
              ...
              },
              {
                spellName: "DEVOUR",
                desc:
                  " - Boss will target random player and suck them in then stun and cast circle AoE.",
                icon: "avoid"
              },
              {
                spellName: "SPIT",
          ...
          },
          {
            ...
            bossTips: [
              ...
              },
              {
                spellName: "MAD DASH",
                desc:
                  " - Targeted players should STACK together on RED marker ; SPREAD on Blue marker.",
                icon: "heal"
              }
            ]
          },
            ...
            bossTips: [
              {
                ...
                desc:
                  " - Tanks should keep the boss facing away from the party.",
                icon: "avoid"
              },
              {
              ...
              },
              {
                spellName: "COMET",
                desc:
                  " - Two players will be marked with green markers, spread apart and run as far to the edge as possible; dodge meteor AoE and drop proximity AoE and run away.",
                icon: "mechanic"
              },
              {
              ...
              },
              {
                ...
                desc:
                  " - Random player targeted with red/orange marker ; run away from party for AoE damage.",
                icon: "mechanic"
              },
              {
                spellName: "DARK STAR",
      ...
      },
      {
        ...
        mainStoryQuest: true,
        dungeonTips: [
          "The slumbering dragon trash mobs can be avoided by running past them."
        ],
        bossList: [
          {
            bossName: "Rangda",
            bossTips: [
              ...
              },
              {
                ...
                desc:
                  " -  tethered player run to tower pillar on side, other players dodge circle AoE.",
                icon: "mechanic"
              },
              {
                desc: "Kill adds asap.",
          ...
          },
          {
            ...
            bossTips: [
              ...
              {
                desc:
                  "Mustard Gas - allow mustard gas to consume 2-3 poison orbs before killing it.",
                icon: "dps"
              }
            ]
          },
          {
            ...
            bossTips: [
              ...
              },
              {
                ...
                desc:
                  " - Boss will spit Fire ball(s) that becomes straight line AoE.",
                icon: "avoid"
              },
              {
              ...
              {
                desc:
                  "'Massacre' -  stand inside shield that Einstein casts to stay alive.",
                icon: "mechanic"
              }
            ]
          }
            ...
            bossTips: [
              {
                ...
                desc:
                  " - Avoid line AoE attack that will leave behind an Aetherial Tear.",
                icon: "avoid"
              },
              {
          ...
          },
          {
            ...
            bossTips: [
              ...
              },
              {
                ...
                desc:
                  "If you are chained to another player, run in opposite directions to break chain.",
                icon: "mechanic"
              },
              {
                desc:
                  "Avoid standing in path of marching knights that are summoned.",
                icon: "avoid"
              },
              {
      ...
      },
      {
        ...
        mainStoryQuest: true,
        dungeonTips: [
          "Page64 adds will target and tether to random party member, stay away from party members."
        ],
        bossList: [
          {
            bossName: "Demon Tome",
          ...
          },
          {
            ...
            bossTips: [
              {
                desc:
                  "When boss become invulnerable; kill adds, and drag the tether to the boss ; AVOID the gas clouds that destroy tether.",
                icon: "mechanic"
              },
              {
                spellName: "HEAD DOWN",
                desc:
                  " - Randomly target party members and charge towards them and damage.",
                icon: "heal"
              },
              {
          ...
          },
          {
            ...
            bossTips: [
              {
                desc:
                  "Targeted (green marker) party members should drop an orb in between the platforms as close to the wall as possible.",
                icon: "avoid"
              },
              {
                spellName: "VOID SUMMON",
                desc:
                  " - When the platforms glow , equal number of party members should step onto the plates in light circles in all platforms to avoid adds being spawned.",
                icon: "mechanic"
              },
              {
    ...
    dungeons: [
      {
        ...
        mainStoryQuest: true,
        dungeonTips: [
          "Be careful of 'Fleshless captive' mini-boss who has an unavoidable room wide AoE stun, prepare to interrupt or heal through."
        ],
        bossList: [
          {
            bossName: "Lugat",
            bossTips: [
              ...
              },
              {
                spellName: "HYDROBALL",
                desc:
                  " - One party member is targeted; STACK to split the damage.",
                icon: "heal"
              },
              {
                spellName: "SEA SWALLOWS ALL --> CONCUSSIVE OSCILLATION",
                desc:
                  " - Boss sucks and damages everyone then immediately casts AoE.",
                icon: "heal"
              }
            ]
          },
          {
            ...
            bossTips: [
              ...
              },
              {
                ...
                desc:
                  " - Random player will be targeted, drawn in and tehered; Run away from boss to avoid Debuff.",
                icon: "mechanic"
              },
              {
                spellName: "SHADOWSPLIT",
                desc:
                  " - Boss will summon a bunch of small versions of himself for a mass ground-covering AoE; Stand in safe spot.",
                icon: "avoid"
              }
            ]
          },
          {
            ...
            bossTips: [
              ...
              },
              {
                ...
                desc:
                  " - Position character so when being forced march or retreat will not run into ground AoE.",
                icon: "mechanic"
              },
              {
      ...
      },
      {
        ...
        mainStoryQuest: false,
        dungeonTips: [
          "Avoid running or stepping into sand with eye tentacles potruding out of sand."
        ],
        bossList: [
          {
            bossName: "Amikiri",
            bossTips: [
              {
                spellName: "PREY",
                desc:
                  " - Random player will be targetted for damage and bound; Kill tail asap to free player.",
                icon: "heal"
              },
              {
              ...
              },
              {
                ...
                desc:
                  " - blue marker on targeted players - split and run to wall.",
                icon: "heal"
              }
            ]
          },
          {
            ...
            bossTips: [
              ...
              },
              {
                ...
                desc:
                  " - AOE from boss and targeted players. Targeted players should drop away from group, then kite away from group.",
                icon: "avoid"
              }
            ]
          },
      ...
      },
      {
        ...
        mainStoryQuest: true,
        dungeonTips: [
          "Be careful of bigger pulls, trash mobs hit harder in this dungeon."
        ],
        bossList: [
          {
            bossName: "Galura",
            bossTips: [
              ...
              },
              {
                ...
                desc:
                  " - boss will mark an off-aggro target and channel a straight line charge; Marked players should distances themselves from Galura. Other players should move out of Galura's path.",
                icon: "heal"
              },
              {
                desc:
          ...
          },
          {
            ...
            bossTips: [
              ...
              {
                desc:
                  "1 player must stand in each of 3 pillars when they are summoned.",
                icon: "mechanic"
              },
              {
                desc:
                  "hide behind rock before meteor strikes the center of the room",
                icon: "mechanic"
              }
            ]
          },
          {
            ...
            bossTips: [
              ...
              },
              {
                ...
                desc:
                  "' - Marks all players with orange markers. Spread out to split damage.",
                icon: "heal"
              },
              {
      ...
      },
      {
        ...
        mainStoryQuest: true,
        dungeonTips: [
          "Tanks should be quick to pick up trash mobs that spawn in different spots."
        ],
        bossList: [
          {
            ...
            bossTips: [
              ...
              {
                desc:
                  "'Wild Speed/Cannons' - The boss will charge around the arena; Kill soldiers and use cannons on boss.",
                icon: "mechanic"
              }
            ]
          },
          {
            ...
            bossTips: [
              ...
              },
              {
                ...
                desc:
                  " - Boss will summon 3 pillars, go into the pillar of elements that he did not say or is not immune to in his status bar.",
                icon: "mechanic"
              }
            ]
          },
